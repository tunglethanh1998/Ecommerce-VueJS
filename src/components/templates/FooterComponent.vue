<template>
  <footer class="wp-block-template-part">
    <div
      ...
      style="background-color: #fff6f2; padding-top: 100px; padding-bottom: 50px"
    >
      <div
        class="is-layout-flex wp-container-74 wp-block-columns alignwide are-vertically-aligned-top"
      >
        <div class="is-layout-flow wp-block-column is-vertically-aligned-top">
          <h2 class="has-text-align-center">Let’s Get Social</h2>

          <ul
            class="is-content-justification-center is-layout-flex wp-container-56 wp-block-social-links aligncenter has-normal-icon-size has-visible-labels has-icon-color is-style-logos-only"
          >
            <li
              style="color: #555555"
            ...
            >
              <a
                href="https://www.instagram.com/themegrill/?hl=en"
                rel="noopener nofollow"
                target="_blank"
                class="wp-block-social-link-anchor"
                ><svg
                ...
                >
                  ...
                  ></path></svg ><span class="wp-block-social-link-label">Instagram</span></a
              >
            </li>
            ...
            >
              <a
                href="https://www.youtube.com/channel/UCxxUb-k2cT43fNXY-V39LXw"
                rel="noopener nofollow"
                target="_blank"
                class="wp-block-social-link-anchor"
                ><svg
                ...
                >
                  ...
                  ></path></svg><span class="wp-block-social-link-label">YouTube</span></a
              >
            </li>
            ...
            >
              <a
                ...
                >
                  ...
                  ></path></svg><span class="wp-block-social-link-label">TikTok</span></a>
            </li>
          </ul>
          ...
          <figure
            class="is-layout-flex wp-block-gallery-57 wp-block-gallery alignwide has-nested-images columns-4 is-cropped"
          >
            <figure class="wp-block-image size-large">
              <a href="#"
                ><img
                  decoding="async"
                  src="https://themegrilldemos.com/blissful/wp-content/themes/blissful/assets/images/gallery-1.png"
                  alt=""
                  class="wp-image-33"
              /></a>
            </figure>
            ...
            <figure class="wp-block-image size-large">
              <a href="#"
                ><img
                  decoding="async"
                  src="https://themegrilldemos.com/blissful/wp-content/themes/blissful/assets/images/gallery-2.png"
                  alt=""
                  class="wp-image-34"
              /></a>
            </figure>
            ...
            <figure class="wp-block-image size-large">
              <a href="#"
                ><img
                  decoding="async"
                  src="https://themegrilldemos.com/blissful/wp-content/themes/blissful/assets/images/gallery-4.png"
                  alt=""
                  class="wp-image-36"
              /></a>
            </figure>
            ...
            <figure class="wp-block-image size-large">
              <a href="#"
                ><img
                  decoding="async"
                  src="https://themegrilldemos.com/blissful/wp-content/themes/blissful/assets/images/gallery-3.png"
                  alt=""
                  class="wp-image-35"
              /></a>
            </figure>
          ...
          <hr
            ...
            style="background-color: #d9d9d9; color: #d9d9d9"
          />
          ...
          <div class="is-content-justification-center is-layout-constrained wp-block-group">
            <div class="is-layout-flex wp-container-71 wp-block-columns alignwide">
              ...
              >
                ...
                <nav
                  class="is-vertical is-content-justification-center is-layout-flex wp-container-60 items-justified-center is-vertical wp-block-navigation"
                  aria-label="Offers"
                >
              ...
              >
                ...
                <nav
                  class="is-vertical is-content-justification-center is-layout-flex wp-container-63 items-justified-center is-vertical wp-block-navigation"
              ...
              >
                ...
                <nav
                  class="is-vertical is-content-justification-center is-layout-flex wp-container-66 items-justified-center is-vertical wp-block-navigation"
              ...
              >
                ...
                <nav
                  class="is-vertical is-content-justification-center is-layout-flex wp-container-69 items-justified-center is-vertical wp-block-navigation"
                ...
                >
                  <ul class="wp-block-navigation__container">
                    ...
                    <li class="wp-block-navigation-item wp-block-navigation-link">
                      <a class="wp-block-navigation-item__content" href="#">
                        <span class="wp-block-navigation-item__label">QR Code</span>
                      </a>
                    </li>
                    <li class="wp-block-navigation-item wp-block-navigation-link">
                      <a class="wp-block-navigation-item__content" href="#">
                        <span class="wp-block-navigation-item__label">Terms &amp; Conditions</span>
                      </a>
                    </li>
                  </ul>
                </nav>
    ...
    <div
      class="is-layout-flex wp-container-77 wp-block-columns has-background"
      style="
